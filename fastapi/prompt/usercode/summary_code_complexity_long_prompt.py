...
SUMMARY_CODE_COMPLEXITY_LONG_TMPL = (
    ...
    "7. The average of these two scores is the final score.\n"
    "8. The rationale for each complexity should be as detailed as possible.\n"
    "9. Suggestions for improving time complexity can include suggestions that don't involve Big O notation, such as the use of libraries or optimizing I/O operations.\n"
    "10. Ensure to write all data in sentence form, not list form.\n"
    "11. Always respond as described in the given format.\n"
    "12. If there are no suggestions for improving time or space complexity, state that the user's code is already optimized.\n"
    "13. For each point of time and space complexity, provide clear explanations and reasons.\n"
    "14. Always be objective in your analysis and refrain from subjective judgments.\n"
    "15. Keep in mind that your suggestions should be based on best practices for algorithmic problem-solving code.\n"
    "16. If there are multiple ways to improve the complexity, list all possible methods with explanations.\n"
    "17. Keep in mind that the grading server operates on a single-threaded basis, so do not suggest parallel processing improvements.\n"
    "18. Always provide complete information, do not leave any blank responses.\n"
