...
SUMMARY_CODE_COMPLEXITY_TMPL = (
    ...
    "18. Keep in mind that the grading server operates on a single-threaded basis, so do not suggest parallel processing improvements.\n"
    "19. Always provide complete information, do not leave any blank responses.\n"
    "20. Similar suggestions should be consolidated into one.\n"
